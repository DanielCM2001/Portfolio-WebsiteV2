<template>
  <div>
    ...
    <section
      class="relative flex items-center justify-center min-h-screen overflow-hidden spacecontainer2"
    >
      <div class="bottom-0 space"></div>
...
export default {
  mounted() {
    ...
    const scene = new ScrollMagic.Scene({
      triggerElement: ".spacecontainer2",
      duration: 2000, // Adjust the duration as needed
      triggerHook: 0,
    })
      .setTween(tween)
      .setPin(".spacecontainer2")
      .addTo(controller);
...
.spacecontainer2 {
  background: linear-gradient(180deg, #000005 0%, #000005 100%);
}
